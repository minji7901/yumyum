...
const TodaysmealOption = ({ label, isSelected, onClick, className = 'w-full' }: TodaysmealOptionProps) => {
  return (
    <button
      type="button"
      onClick={onClick}
      className={`px-6 py-3 font-medium border-2 rounded-full text-center  transition-all duration-300 ${
